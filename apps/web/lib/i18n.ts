...
const MESSAGES = {
  id: {
    ...
    "news.title": "Semua Berita",
    "news.metaDescription": "Semua berita yang diterbitkan, terbaru lebih dulu, dari",
  ...
  en: {
    ...
    "news.title": "All News",
    "news.metaDescription": "Every published story, most recent first, from",
